    ...
    <div style={{ background: "#fff" }}>
      <div className="address" onClick={HandleClick}>
        <div className="add-loc">
          <div className="location">
            ...
            <div className="loc">Location not set</div>
          </div>
          <div className="location">
            <div className="del">Select delivery location</div>
      ...
      <Link to="/search">
        <div className="searchbox">
          <div className="srchbx-padd">
            <div className="srch-txt-logo">
              <div className="location">
      ...
      <Location isVisible={isVisible} HandleClick={HandleClick} />
    </div>
  );
}
